...
class DQNModel(torch.nn.Module):  # ModelDQN
    ...
    def __init__(self,
        ...
        # Architecture 1 (Two convolutional layers) - Without batch normalization
    ...
    def model_summary(self,
        ...
        if (next(self.parameters()).is_cuda):
            device = 'cuda'
        return summary(self, (self.in_channels, self.shape_input[0], self.shape_input[1]), batch_size=-1, device=device)
